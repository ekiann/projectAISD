...
################################################################################
## Form generated from reading UI file 'completed_tests.ui'
##
...
class Ui_CompletedTests(object):
    def setupUi(self, CompletedTests):
        if not CompletedTests.objectName():
            CompletedTests.setObjectName(u"CompletedTests")
        CompletedTests.resize(1440, 1024)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(CompletedTests.sizePolicy().hasHeightForWidth())
        CompletedTests.setSizePolicy(sizePolicy)
        CompletedTests.setMinimumSize(QSize(700, 700))
        CompletedTests.setStyleSheet(u"background-color: rgb(2, 49, 93);\n"
"color: #ffffff;\n"
"font: 10pt \"URW Gothic\";")
        self.centralwidget = QWidget(CompletedTests)
...
"font: 10pt \"URW Gothic\";")
        ...
        self.menu_button.setStyleSheet(u"background-image: url(:/completed_test_img/menu.png);\n"
"border: 0px;\n"
"border-radius: 25;")
...
"color: rgb(255, 255, 255);")
        ...
        self.arrow_button.setStyleSheet(u"border: none;")
        icon = QIcon()
        icon.addFile(u":/completed_test_img/arrow.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border: none;")
        icon1 = QIcon()
        icon1.addFile(u":/completed_test_img/double_arrow.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border: none;")
        ...
        sizePolicy.setHeightForWidth(self.complete_2.sizePolicy().hasHeightForWidth())
        self.complete_2.setSizePolicy(sizePolicy)
...
"color: rgb(255, 255, 255);")
        ...
        self.photo.setStyleSheet(u"background-image: url(:/completed_test_img/user.png);\n"
...
"QWidget{font: 10pt \"URW Gothic\";}")
        ...
        CompletedTests.setCentralWidget(self.centralwidget)
        self.frame_4.raise_()
        self.frame_5.raise_()
        self.groupBox.raise_()
        self.line.raise_()
        self.menubar = QMenuBar(CompletedTests)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1440, 22))
        CompletedTests.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(CompletedTests)
        self.statusbar.setObjectName(u"statusbar")
        CompletedTests.setStatusBar(self.statusbar)

        self.retranslateUi(CompletedTests)

        QMetaObject.connectSlotsByName(CompletedTests)
    # setupUi

    def retranslateUi(self, CompletedTests):
        CompletedTests.setWindowTitle(QCoreApplication.translate("CompletedTests", u"CompletedTests", None))
        self.groupBox.setTitle("")
        self.menu_button.setText("")
        self.lk_button.setText(QCoreApplication.translate("CompletedTests", u"\u041b\u0438\u0447\u043d\u044b\u0439 \u043a\u0430\u0431\u0438\u043d\u0435\u0442", None))
        self.my_tests_button.setText(QCoreApplication.translate("CompletedTests", u"\u041c\u043e\u0438 \u0442\u0435\u0441\u0442\u044b", None))
        self.arrow_button.setText("")
        self.new_4.setText("")
        self.new_3.setText(QCoreApplication.translate("CompletedTests", u"\u041d\u043e\u0432\u044b\u0435", None))
        self.complete_3.setText("")
        self.complete_2.setText(QCoreApplication.translate("CompletedTests", u"\u0412\u044b\u043f\u043e\u043b\u043d\u0435\u043d\u043d\u044b\u0435", None))
        self.photo.setText("")
        self.label.setText(QCoreApplication.translate("CompletedTests", u"\u0412\u044b\u043f\u043e\u043b\u043d\u0435\u043d\u043d\u044b\u0435 \u0442\u0435\u0441\u0442\u044b", None))
    # retranslateUi
